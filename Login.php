...
?>
<!doctype html>
<!-- forms to log in to the website, can tab between tradesman and customer forms -->
<html lang="en">
<head>
    <!-- Needed to create a separate header and not include the nav since it doesn't need menu buttons here. -->
<meta charset="utf-8">
